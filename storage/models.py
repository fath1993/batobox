...
class Storage(models.Model):
    alt = models.CharField(max_length=255, null=True, blank=True, verbose_name='متن جایگزین فایل')
    file = models.FileField(upload_to='storage/', null=True, blank=True, verbose_name='فایل')
